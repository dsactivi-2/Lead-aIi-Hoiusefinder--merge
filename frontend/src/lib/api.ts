...
export async function getHousing(filters?: {
  ...
  if (filters?.mietvertrag_possible !== undefined) params.append("mietvertrag_possible", filters.mietvertrag_possible.toString())
  if (filters?.limit) params.append("limit", filters.limit.toString())
...
export async function getCandidates(filters?: {
  ...
  return fetchWithValidation(url, { method: "GET" }, CandidatesResponseSchema)
}
...
// ============================================================================
// ATU RELOCATION - RELOCATION REQUESTS API
// ============================================================================
...
// ============================================================================
// ATU RELOCATION - NEGOTIATIONS API
// ============================================================================
...
export async function getNegotiations(filters?: {
  ...
  return fetchWithValidation(url, { method: "GET" }, NegotiationsResponseSchema)
}
...
export async function getDeals(filters?: {
  ...
  return fetchWithValidation(url, { method: "GET" }, DealsResponseSchema)
}
...
// ============================================================================
// ATU RELOCATION - AGENT ENDPOINTS
// ============================================================================
